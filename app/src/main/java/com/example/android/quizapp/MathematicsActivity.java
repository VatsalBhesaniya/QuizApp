...
public class MathematicsActivity extends AppCompatActivity {
    ...
    private QuestionsMathematics mQuestions = new QuestionsMathematics();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedId == -1) {
                    Toast toast = Toast.makeText(MathematicsActivity.this, R.string.error_message, Toast.LENGTH_LONG);
                    toast.show();
                } else {
                    answerSelected = (RadioButton) findViewById(selectedId);
                    if (answerSelected.getText() == mAnswer) {
                        Toast.makeText(MathematicsActivity.this, R.string.toast_correct, Toast.LENGTH_SHORT).show();
                        mscore++;
                        score.setText(getString(R.string.score, mscore));
                    } else {
                        Toast.makeText(MathematicsActivity.this, R.string.toast_wrong, Toast.LENGTH_SHORT).show();
                    }
                    progress += 10;
    ...
    //This method will update the question
    ...
    private void gamecompleted() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MathematicsActivity.this);
                ...
                .setPositiveButton(R.string.btn_submit,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Toast toast = Toast.makeText(MathematicsActivity.this, getString(R.string.quiz_result, mQuestionsLength, mscore), Toast.LENGTH_LONG);
