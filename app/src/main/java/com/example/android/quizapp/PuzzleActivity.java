...
public class PuzzleActivity extends AppCompatActivity {
    ...
    private ImageView image_puzzles;
    ...
    private QuestionsPuzzle mQuestions = new QuestionsPuzzle();
    private QuestionsPuzzle mImages = new QuestionsPuzzle();
    private String mAnswer;
    private int mscore = 0;
    private int mQuestionsLength = mImages.mImages.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image_puzzles = (ImageView) findViewById(R.id.image_puzzles);
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedId == -1) {
                    Toast toast = Toast.makeText(PuzzleActivity.this, R.string.error_message, Toast.LENGTH_LONG);
                    toast.show();
                } else {
                    answerSelected = (RadioButton) findViewById(selectedId);
                    if (answerSelected.getText() == mAnswer) {
                        Toast.makeText(PuzzleActivity.this, R.string.toast_correct, Toast.LENGTH_SHORT).show();
                        mscore++;
                        score.setText(getString(R.string.score, mscore));
                    } else {
                        Toast.makeText(PuzzleActivity.this, R.string.toast_wrong, Toast.LENGTH_SHORT).show();
                    }
                    progress += 10;
    ...
    private void updateQuestion(int n) {
        if (nextQuestion < mQuestionsLength) {
            nextQuestion++;
            image_puzzles.setImageResource(mImages.getImage(n));
                ...
                .setPositiveButton(R.string.btn_submit,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Toast toast = Toast.makeText(PuzzleActivity.this, getString(R.string.quiz_result, mQuestionsLength, mscore), Toast.LENGTH_LONG);
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        score.setText(getString(R.string.score, mscore));
        image_puzzles.setImageResource(mImages.getImage(nextQuestion - 1));
