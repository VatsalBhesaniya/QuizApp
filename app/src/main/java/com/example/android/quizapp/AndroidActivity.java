...
public class AndroidActivity extends AppCompatActivity {
    ...
    private QuestionsAndroid mQuestions = new QuestionsAndroid();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedId == -1) {
                    Toast toast = Toast.makeText(AndroidActivity.this, R.string.error_message, Toast.LENGTH_LONG);
                    toast.show();
                } else {
                    answerSelected = (RadioButton) findViewById(selectedId);
                    if (answerSelected.getText() == mAnswer) {
                        Toast.makeText(AndroidActivity.this, R.string.toast_correct, Toast.LENGTH_SHORT).show();
                        mscore++;
                        score.setText(getString(R.string.score, mscore));
                    } else {
                        Toast.makeText(AndroidActivity.this, R.string.toast_wrong, Toast.LENGTH_SHORT).show();
                    }
                    progress += 10;
    ...
    private void gamecompleted() {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(AndroidActivity.this);
                ...
                .setPositiveButton(R.string.btn_submit,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                Toast toast = Toast.makeText(AndroidActivity.this, getString(R.string.quiz_result, mQuestionsLength, mscore), Toast.LENGTH_LONG);
